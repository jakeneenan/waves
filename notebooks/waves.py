...
slit_distance = 20 * np.pi       # Distance of the center of the two slits. Only relevant for double-slit scenarios.
...
for type_of_simulation in ["single_wave", "single_slit_diffraction"]:
